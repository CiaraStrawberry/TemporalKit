...
class EBSynthKeyFrame:
    ...
    def __init__(self, inuseFirstFrame=False, inuseLastFrame=False, infirstFrame=0, inkeyFrame=0, inlastFrame=0,
                 inoutputPath=""):
...
class EBSynthProject:
    ...
    def WriteToFile(self, filePath):
        ...
        unknownBA = bytearray(
            b'\x00\x00\x80\x3F\x00\x00\x80\x40\x00\x00\x80\x3F\x00\x00\x20\x41\x00\x00\x80\x3F\x00\xC0\x5A\x45')
    ...
    def AddKeyFrame(self, useFirstFrame=False, useLastFrame=False, firstFrame=0, keyFrame=0, lastFrame=0,
                    outputPath=""):
